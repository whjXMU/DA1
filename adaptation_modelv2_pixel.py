...
from pixel.utlis import to_cuda, get_world_size
import pixel_utils as solver_utils
...
class CustomModel():
    ...
    def association(self, data_S, gt_S, data_T, gt_T):
        ...
        res_T = self.BaseNet_DP(data_T)
        preds_T = res_T['out']
        feats_T = res_T['feat']


        res_S = self.BaseNet_DP(data_S)
        preds_S = res_S['out']
        feats_S = res_S['feat']
        ...
        # ce_loss += (0.75 * get_world_size() ) * lov_loss
