...
def parser_(parser):
    parser.add_argument('--root', type=str, default='/home/hjw/proda-mine/', help='root path')
    parser.add_argument('--model_name', type=str, default='deeplabv2', help='deeplabv2')
    parser.add_argument('--name', type=str, default='bai2dian', help='pretrain source model')
    parser.add_argument('--lr', type=float, default=0.00005)#0.0001
    ...
    #data
    parser.add_argument('--src_dataset', type=str, default='bai', help='bai_all')
    parser.add_argument('--src_dataset_E', type=str, default='bai_easy', help='bai_easy')
    parser.add_argument('--src_dataset_H', type=str, default='bai_hard', help='bai_hard')
    parser.add_argument('--tgt_dataset', type=str, default='dian', help='dian_all')
    parser.add_argument('--tgt_dataset_E', type=str, default='dian_easy', help='dian_easy')
    parser.add_argument('--tgt_dataset_E_label', type=str, default='dian_easy_label', help='dian_easy_label')
    parser.add_argument('--tgt_dataset_H', type=str, default='dian_hard', help='dian_hard')
    parser.add_argument('--src_rootpath', type=str, default='Dataset/bai')
    parser.add_argument('--tgt_rootpath', type=str, default='Dataset/dian')
    ...
    parser.add_argument('--rcrop', type=str, default='300,300', help='rondom crop size')
    parser.add_argument('--hflip', type=float, default=0.5, help='random flip probility')

    parser.add_argument('--n_class', type=int, default=2, help='2')
