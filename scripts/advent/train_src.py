...
from advent.dataset.bai import baiDataSet
from advent.dataset.dian import dianDataSet
from advent.domain_adaptation.config import cfg, cfg_from_file
from advent.domain_adaptation.train_src import train_src_only
...
def main():
    ...
    source_dataset = baiDataSet(root=cfg.DATA_DIRECTORY_SOURCE,
    ...
    target_dataset = dianDataSet(root=cfg.DATA_DIRECTORY_TARGET,
    ...
    # train src
    train_src_only(model, source_loader, target_loader, cfg)
