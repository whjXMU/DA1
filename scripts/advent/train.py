...
def main():
    ...
    if cfg.EXP_NAME == '':
        cfg.EXP_NAME = f'{cfg.SOURCE}_all2{cfg.TARGET}_{cfg.TRAIN.MODEL}_{cfg.TRAIN.DA_METHOD}'
    ...
    pprint.pprint(cfg)
    # INIT
    logdir='/home/hjw/advent/advent/logs/'+args.dir
    ...
    if cfg.TRAIN.MODEL == 'DeepLabv2':
        ...
        if 'DeepLab_resnet_pretrained_imagenet' in cfg.TRAIN.RESTORE_FROM:
            ...
            model.load_state_dict(new_params) #put parameters in model except layer5 
        else:
    ...
    source_dataset = eyeDataSet(root=cfg.DATA_DIRECTORY_SOURCE,
    ...
    target_dataset = eye_TDataSet(root=cfg.DATA_DIRECTORY_TARGET,
    ...
    val_dataset = eye_TDataSet(root=cfg.DATA_DIRECTORY_TARGET,
                                     list_path=cfg.DATA_LIST_TARGET,
    ...
    # UDA TRAINING
    train_domain_adaptation(model, source_loader, target_loader, val_loader,cfg,logger)
