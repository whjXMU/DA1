...
import pprint
import warnings
from advent.dataset.eye import eyeDataSet
from advent.dataset.eye_T import eye_TDataSet
...
def main(config_file, exp_suffix):
    ...
    if cfg.TEST.SNAPSHOT_DIR[0] == '':
        cfg.TEST.SNAPSHOT_DIR[0] = osp.join(cfg.EXP_ROOT_SNAPSHOT,cfg.EXP_NAME,'src')
    ...
    # dataloaders
    test_dataset = eye_TDataSet(root=cfg.DATA_DIRECTORY_TARGET,
    ...
    print("val!:")
    evaluate_domain_adaptation(models, val_loader, cfg)
