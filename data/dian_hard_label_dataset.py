...
class dian_hard_label_loader(BaseDataset):
    """cityscapesLoader
    ...
    def __init__(self, opt, logger, augmentations = None, split='train_hard'):
        """__init__
        ...
        self.label_base_path = "/home/hjw/proda-mine/Dataset/dian/labels/"
    ...
    def __getitem__(self, index):
        ...
        if self.split in ['train' ,'train_easy','train_hard']and self.opt.used_save_pseudo:
