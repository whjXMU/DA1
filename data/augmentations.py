...
class Compose(object):
    ...
    def __call__(self, img, mask, mask1=None, lpsoft=None):
        ...
        for a in self.augmentations:
            # print("a______{}".format(a(img, mask, mask1, lpsoft, params)))
            jaincha = a(img, mask, mask1, lpsoft, params)
            # print("jaincha =", str(len(jaincha)))
            # print(jaincha[0].size)
            # print(jaincha[1].size)
            # print(jaincha[2])
            # print(jaincha[3])
            # print(str(len(jaincha[4])))
